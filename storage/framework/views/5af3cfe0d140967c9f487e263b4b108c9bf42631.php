        ...
        <div class="card border-dark pt-5 ps-5">
            <div class="row align-items-center mt-4">
                ...
                <div class="col-3 ms-5">
                    <input type="text" name="nom" id="inputName" class="form-control ms-5" placeholder="Maxence">  
                </div>
            </div>
            ...
            <div class="row align-items-center mt-4">
                ...
                <div class="col-4 ms-5">
                    <input type="text" name="adresse" id="inputAddress" class="form-control ms-5" placeholder="3 avenue du Blues">  
                </div>
            </div>
            ...
            <div class="row align-items-center mt-4">
                ...
                <div class="col-2 ms-5">
                    <input type="text" name="cp" id="inputPostalCode" class="form-control ms-5" placeholder="L-4368">  
                </div>
            </div>
            ...
            <div class="row align-items-center mt-4">
                ...
                <div class="col-3 ms-5">
                    <input type="text" name="ville" id="inputCity" class="form-control ms-5" placeholder="Belval">  
                </div>
            </div>
...
<?php echo $__env->make('clients.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel_only\resources\views/clients/create.blade.php ENDPATH**/ ?>