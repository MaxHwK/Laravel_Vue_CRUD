...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-around mt-5">
        ...
        <div class="card border-dark text-center col-md-3">
            ...
            <div class="card-body">
                <h6 class="card-text"><?php echo e($client->country->libelle); ?></h6>
            </div>        
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('clients.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel_only\resources\views/clients/show.blade.php ENDPATH**/ ?>