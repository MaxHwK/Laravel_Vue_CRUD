    ...
    <form action="<?php echo e(route('clients.update',$client->id)); ?>" method="POST">
        ...
        <div class="row align-items-center mt-4">
                ...
                <div class="col-3 ms-5">
                    <input type="text" name="nom" value="<?php echo e($client->nom); ?>" id="inputName" class="form-control ms-5" placeholder="(ex: Maxence)">  
                </div>
            </div>
            ...
            <div class="row align-items-center mt-4">
                ...
                <div class="col-4 ms-5">
                    <input type="text" name="adresse" value="<?php echo e($client->adresse); ?>" id="inputAddress" class="form-control ms-5" placeholder="(ex: 3 avenue du Blues)">  
                </div>
            </div>
            ...
            <div class="row align-items-center mt-4">
                ...
                <div class="col-2 ms-5">
                    <input type="text" name="cp" value="<?php echo e($client->cp); ?>" id="inputPostalCode" class="form-control ms-5" placeholder="(ex: L-4368)">  
                </div>
            </div>
            ...
            <div class="row align-items-center mt-4">
                ...
                <div class="col-3 ms-5">
                    <input type="text" name="ville" value="<?php echo e($client->ville); ?>" id="inputCity" class="form-control ms-5" placeholder="(ex: Belval)">  
                </div>
            </div>
...
<?php echo $__env->make('clients.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel_vue\resources\views/clients/edit.blade.php ENDPATH**/ ?>