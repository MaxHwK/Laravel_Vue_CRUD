...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-between mt-5">
        <div class="card border-dark text-center col-md-3">
            ...
            <div class="card-body">
                <h6 class="card-text"><?php echo e($project->client->nom); ?></h6>
            </div>        
        </div>
        <div class="card border-dark text-center col-md-3">
            <h5 class="card-header">Type</h5>
            <div class="card-body">
                <h6 class="card-text"><?php echo e($project->type->libelle); ?></h6>
            </div>        
        </div>
        <div class="card border-dark text-center col-md-3">
...
<?php echo $__env->make('projects.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel_only\resources\views/projects/show.blade.php ENDPATH**/ ?>